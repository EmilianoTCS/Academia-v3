...
class ListadoCursos extends Component {
  ...
  loadListadoRelatores(){
          fetch(
            "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/auxiliar/ListadoRelatores.php?listadoRelatores"
          )
          .then((response) => response.json())
          .then((dataResponse) => {
  ...
  loadListadoCuentas(){
          fetch(
            "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/auxiliar/ListadoCuentas.php?listadoCuentas"
          )
          .then((response) => response.json())
          .then((dataResponse) => {
  ...
  loadData() {
    fetch(
      "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-listCuentas.php"
    )
      .then((response) => response.json())
      .then((dataResponse) => {
  ...
  loadPaginador() {
    fetch(
      "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/paginador/botones_Cuenta.php"
    )
      .then((response) => response.json())
      .then((dataResponse) => {
  ...
  sendNum = (e) => {
    ...
    fetch(
      "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-listCuentas.php?pagina",
      {
        method: "POST",
  ...
  sendDataRamo = (e) =>{
        ...
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-insertarRamo.php?insertarRamo",{
            method: "POST",
  ...
  sendDataCurso = (e) =>{
        ...
        console.log(datosEnviar);
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-insertarCurso.php?insertarCurso",{
            method: "POST",
            body: JSON.stringify(datosEnviar)
          }
        )
  ...
  loadDataEdit(ID) {
  fetch(
    "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-selectCuentas.php?ID="+ID
  )
    .then((response) => response.json())
    .then((dataResponse) => {
  ...
  const ID = (this.state.cursosEdit.IDEdit);
    ...
    console.log(datosEnviar);
  fetch(
    "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-editCurso.php?editarCurso",{
      method: "POST",
      body: JSON.stringify(datosEnviar)
    }
  )
