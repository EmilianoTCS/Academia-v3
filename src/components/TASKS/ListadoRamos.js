...
class ListadoRamos extends Component {
    state = { 
      ...
      loadData() {
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-listCursos.php"
        )
          .then((response) => response.json())
          .then((dataResponse) => {
      ...
      loadPaginador() {
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/paginador/botones_Cursos.php"
        )
          .then((response) => response.json())
          .then((dataResponse) => {
      ...
      sendNum = (e) => {
        ...
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-listCursos.php?pagina",
          {
            method: "POST",
      ...
      loadDataEdit(ID) {
        fetch(
          "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-selectCursos.php?ID="+ID
        )
          .then((response) => response.json())
          .then((dataResponse) => {
      ...
      fetch(
        "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-editRamo.php?editarRamo",{
          method: "POST",
          body: JSON.stringify(datosEnviar)
        }
      )
