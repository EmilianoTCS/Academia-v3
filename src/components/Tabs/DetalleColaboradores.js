...
class DetalleColaboradores extends Component {
    ...
    loadData() {
    fetch(
      "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-listColaboradores.php"
    )
...
this.setState({ toggle_formEdit: false });
    ...
    loadDataEdit(ID) {
  fetch(
  "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-selectColaborador.php?ID="+ID )
   .then((response) => response.json())
   .then((dataResponse) => {
    ...
    sendDataColaboradoresEdit = (e) =>{
      ...
      fetch(
      "http://localhost/App_v2/AcademiaFormaci%C3%B3n_V2/TASKS/coe-editColaborador.php?editarColaborador",{
      method: "POST",
      body: JSON.stringify(datosEnviar)
      })
      .then((response) => response.json())
